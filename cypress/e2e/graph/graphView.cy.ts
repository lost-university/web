...
describe("Graph View E2E Tests", () => {
  beforeEach(() => {
    cy.intercept("GET", "https://raw.githubusercontent.com/lost-university/data/5.5/data/modules.json", {
      fixture: "modules.json",
    }).as("modules");

    cy.intercept(
      "GET",
      "https://raw.githubusercontent.com/lost-university/data/5.5/data2I/categories.json",
