    ...
    <div class="fixed inset-0">
      <div class="flex h-full items-center justify-center">
        <DialogPanel class="w-full max-w-md py-3 px-6 text-center rounded-2xl bg-neutral-100 shadow-xl">
          <DialogTitle as="h3" class="text-xl mb-3">
          ...
          <div class="text-left">
            <div class="mb-2">
              <div>
                <input id="existing-module" v-model="accreditationType" type="radio" name="accreditation-type" value="existing-module" class="mr-2">
            ...
            <div class="mb-3">
              <div>
                <input id="external-module" v-model="accreditationType" type="radio" name="accreditation-type" value="external-module" class="mr-2">
          ...
          <div class="grid grid-flow-row mb-3" v-if="accreditationType === 'existing-module'">
          ...
          <div class="grid gap-2 w-1/2 mx-auto mb-4" v-if="accreditationType === 'external-module'">
            <div class="grid text-left">
              <div>
                <label for="external-name" class="mr-2">Name</label>
                <font-awesome-icon :icon="['fa', 'circle-question']" class="text-gray-500" title="Name darf '.', '-', '_', '~' nicht enthalten und max 30 Zeichen sein" />
              </div>
              <input
                id="external-name"
            ...
            <div class="grid text-left">
              ...
              >
                <div class="relative">
                  ...
                  <ListboxButton class="flex justify-between w-full min-h-8 rounded-lg bg-gray-100 p-2 text-left shadow-md">
                    <span>
                  ...
                  >
                    <ListboxOption
                      ...
                      :value="cat"
                      as="template">
                      <li class="px-2 py-1 cursor-pointer" :class="active ? 'bg-gray-200' : ''">
...
export default defineComponent({
  ...
  computed: {
    ...
    canSaveExternalModule(): boolean {
      return !!this.externalName && !!this.externalEcts && !!this.externalCategories.length && !this.externalName.match(/[.\-_~]/g);
    },
  ...
  methods: {
    ...
    saveExternalModule() {
      if(this.canSaveExternalModule) {
        const accreditedModule = AccreditedModule.createFromExternalData(this.externalName, this.externalEcts, this.externalCategories.map(m => m.id));
